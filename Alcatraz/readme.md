...
You cannot modify the jail.py file. Your input will be evaluated on the version of the file provided here.

In your submission clearly include the payload (the input which prints flag.txt) and also a writeup explaining what the payload does.
